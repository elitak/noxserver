...
enum NoxSubclassType
{
	...
	SUBCLASS_STAFF_OBLIVION_ORB = 0x3A,
     SUBCLASS_SMALL_MONSTER = 0x3B,
     SUBCLASS_MEDIUM_MONSTER = 0x3C,
     SUBCLASS_LARGE_MONSTER = 0x3D,
     SUBCLASS_SHOPKEEPER = 0x3E,
     SUBCLASS_NPC = 0x3F,
     SUBCLASS_FEMALE_NPC = 0x40,
     SUBCLASS_UNDEAD = 0x41,
     SUBCLASS_MONITOR = 0x42,
     SUBCLASS_MIGRATE = 0x43,
     SUBCLASS_IMMUNE_POISON = 0x44,
     SUBCLASS_IMMUNE_FIRE = 0x45,
     SUBCLASS_IMMUNE_ELECTRICITY = 0x46,
     SUBCLASS_IMMUNE_FEAR = 0x47,
     SUBCLASS_BOMBER = 0x48,
     SUBCLASS_NO_TARGET = 0x49,
     SUBCLASS_NO_SPELL_TARGET = 0x4A,
     SUBCLASS_HAS_SOUL = 0x4B,
     SUBCLASS_WARCRY_STUN = 0x4C,
     SUBCLASS_LOOK_AROUND = 0x4D,
     SUBCLASS_WOUNDED_NPC = 0x4E,
     SUBCLASS_SIMPLE = 0x4F,
     SUBCLASS_APPLE = 0x50,
     SUBCLASS_JUG = 0x51,
     SUBCLASS_POTION = 0x52,
     SUBCLASS_HEALTH_POTION = 0x53,
     SUBCLASS_MANA_POTION = 0x54,
     SUBCLASS_CURE_POISON_POTION = 0x55,
     SUBCLASS_MUSHROOM = 0x56,
     SUBCLASS_HASTE_POTION = 0x57,
     SUBCLASS_INVISIBILITY_POTION = 0x58,
     SUBCLASS_SHIELD_POTION = 0x59,
     SUBCLASS_FIRE_PROTECT_POTION = 0x5A,
     SUBCLASS_SHOCK_PROTECT_POTION = 0x5B,
     SUBCLASS_POISON_PROTECT_POTION = 0x5C,
     SUBCLASS_INVULNERABILITY_POTION = 0x5D,
     SUBCLASS_INFRAVISION_POTION = 0x5E,
     SUBCLASS_VAMPIRISM_POTION = 0x5F,
     SUBCLASS_HEAVY = 0x60,
     SUBCLASS_LAVA = 0x61,
     SUBCLASS_GATE = 0x62,
     SUBCLASS_VISIBLE_OBELISK = 0x63,
     SUBCLASS_INVISIBLE_OBELISK = 0x64,
     SUBCLASS_TECH = 0x65,
     SUBCLASS_LOTD = 0x66,
     SUBCLASS_USEABLE = 0x67,
     SUBCLASS_CHEST_NW = 0x68,
     SUBCLASS_CHEST_NE = 0x69,
     SUBCLASS_CHEST_SE = 0x6A,
     SUBCLASS_CHEST_SW = 0x6B,
     SUBCLASS_STONE_DOOR = 0x6C,
     SUBCLASS_SPELL_BOOK = 0x6D,
     SUBCLASS_FIELD_GUIDE = 0x6E,
     SUBCLASS_ABILITY_BOOK = 0x6F,
     SUBCLASS_MISSILE_COUNTERSPELL = 0x70,
     SUBCLASS_MAGIC = 0x71,
     SUBCLASS_GENERATOR_NW = 0x72,
     SUBCLASS_GENERATOR_NE = 0x73,
     SUBCLASS_GENERATOR_SE = 0x74,
     SUBCLASS_GENERATOR_SW = 0x75,
     SUBCLASS_QUEST_EXIT = 0x76,
     SUBCLASS_QUEST_WARP_EXIT = 0x77
};
enum NoxFlagType
{
...
enum NoxPickupType
{
     ...
     PICKUP_ABILITYBOOK,
     PICKUP_CROWN,
     PICKUP_AUDEVENT,//LOL WTF
     PICKUP_ANKHTRADEABLE
};
...
class ThingBin : public boost::singleton<ThingBin>
{
public:
         char Type[5];
         ThingDB Thing;
