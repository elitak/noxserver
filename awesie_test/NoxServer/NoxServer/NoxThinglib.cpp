...
NoxEnumNamePair g_noxSubclassNames[] =
{
	...
	SUBCLASS_STAFF_OBLIVION_ORB, "STAFF_OBLIVION_ORB",
     SUBCLASS_STAFF_OBLIVION_ORB, "STAFF_OBLIVION_ORB",
     SUBCLASS_SMALL_MONSTER, "SMALL_MONSTER",
     SUBCLASS_MEDIUM_MONSTER, "MEDIUM_MONSTER",
     SUBCLASS_LARGE_MONSTER, "LARGE_MONSTER",
     SUBCLASS_SHOPKEEPER, "SHOPKEEPER",
     SUBCLASS_NPC, "NPC",
     SUBCLASS_FEMALE_NPC, "FEMALE_NPC",
     SUBCLASS_UNDEAD, "UNDEAD",
     SUBCLASS_MONITOR, "MONITOR",
     SUBCLASS_MIGRATE, "MIGRATE",
     SUBCLASS_IMMUNE_POISON, "IMMUNE_POISON",
     SUBCLASS_IMMUNE_FIRE, "IMMUNE_FIRE",
     SUBCLASS_IMMUNE_ELECTRICITY, "IMMUNE_ELECTRICITY",
     SUBCLASS_IMMUNE_FEAR, "IMMUNE_FEAR",
     SUBCLASS_BOMBER, "BOMBER",
     SUBCLASS_NO_TARGET, "NO_TARGET",
     SUBCLASS_NO_SPELL_TARGET, "NO_SPELL_TARGET",
     SUBCLASS_HAS_SOUL, "HAS_SOUL",
     SUBCLASS_WARCRY_STUN, "WARCRY_STUN",
     SUBCLASS_LOOK_AROUND, "LOOK_AROUND",
     SUBCLASS_WOUNDED_NPC, "WOUNDED_NPC",
     SUBCLASS_SIMPLE, "SIMPLE",
     SUBCLASS_APPLE, "APPLE",
     SUBCLASS_JUG, "JUG",
     SUBCLASS_POTION, "POTION",
     SUBCLASS_HEALTH_POTION, "HEALTH_POTION",
     SUBCLASS_MANA_POTION, "MANA_POTION",
     SUBCLASS_CURE_POISON_POTION, "CURE_POISON_POTION",
     SUBCLASS_MUSHROOM, "MUSHROOM",
     SUBCLASS_HASTE_POTION, "HASTE_POTION",
     SUBCLASS_INVISIBILITY_POTION, "INVISIBILITY_POTION",
     SUBCLASS_SHIELD_POTION, "SHIELD_POTION",
     SUBCLASS_FIRE_PROTECT_POTION, "FIRE_PROTECT_POTION",
     SUBCLASS_SHOCK_PROTECT_POTION, "SHOCK_PROTECT_POTION",
     SUBCLASS_POISON_PROTECT_POTION, "POISON_PROTECT_POTION",
     SUBCLASS_INVULNERABILITY_POTION, "INVULNERABILITY_POTION",
     SUBCLASS_INFRAVISION_POTION, "INFRAVISION_POTION",
     SUBCLASS_VAMPIRISM_POTION, "VAMPIRISM_POTION",
     SUBCLASS_HEAVY, "HEAVY",
     SUBCLASS_LAVA, "LAVA",
     SUBCLASS_GATE, "GATE",
     SUBCLASS_VISIBLE_OBELISK, "VISIBLE_OBELISK",
     SUBCLASS_INVISIBLE_OBELISK, "INVISIBLE_OBELISK",
     SUBCLASS_TECH, "TECH",
     SUBCLASS_LOTD, "LOTD",
     SUBCLASS_USEABLE, "USEABLE",
     SUBCLASS_CHEST_NW, "CHEST_NW",
     SUBCLASS_CHEST_NE, "CHEST_NE",
     SUBCLASS_CHEST_SE, "CHEST_SE",
     SUBCLASS_CHEST_SW, "CHEST_SW",
     SUBCLASS_STONE_DOOR, "STONE_DOOR",
     SUBCLASS_SPELL_BOOK, "SPELL_BOOK",
     SUBCLASS_FIELD_GUIDE, "FIELD_GUIDE",
     SUBCLASS_ABILITY_BOOK, "ABILITY_BOOK",
     SUBCLASS_MISSILE_COUNTERSPELL, "MISSILE_COUNTERSPELL",
     SUBCLASS_MAGIC, "MAGIC",
     SUBCLASS_GENERATOR_NW, "GENERATOR_NW",
     SUBCLASS_GENERATOR_NE, "GENERATOR_NE",
     SUBCLASS_GENERATOR_SE, "GENERATOR_SE",
     SUBCLASS_GENERATOR_SW, "GENERATOR_SW",
     SUBCLASS_QUEST_EXIT, "QUEST_EXIT",
     SUBCLASS_QUEST_WARP_EXIT, "QUEST_WARP_EXIT",
	0, NULL
};
...
NoxEnumNamePair g_noxPickupNames[] =
{
     PICKUP_DEFEAULT, "DefaultPickup",
     PICKUP_FOOD, "FoodPickup",
     PICKUP_USE, "UsePickup",
     PICKUP_ARMOR, "ArmorPickup",
     PICKUP_WEAPON, "WeaponPickup",
     PICKUP_OBLIVION, "OblivionPickup",
     PICKUP_TREASURE, "TreasurePickup",
     PICKUP_TRAP, "TrapPickup",
     PICKUP_POTION, "PotionPickup",
     PICKUP_GOLD, "GoldPickup",
     PICKUP_AMMO, "AmmoPickup",
     PICKUP_SPELLBOOK, "SpellBookPickup",
     PICKUP_ABILITYBOOK, "AbilityBookPickup",
     PICKUP_CROWN, "CrownPickup",
     PICKUP_AUDEVENT, "AudEventPickup",
     PICKUP_ANKHTRADEABLE, "AnkhTradablePickup",
     0, NULL
};
...
while(strcmp(Type,"GNHT") && count<filelen)
	  {
		...
		if(aniType==0 && strLen > 0)
		{
		  ...
		  else if(!strcmp(string, "USE"))
		  {
 		  ...
 		  else if(!strcmp(string, "PICKUP"))
		  {
			  strtok(NULL, " +"); // =
			  if( (string = strtok(NULL, " +")) != NULL)
			  {
				  Object.pickup = noxNameToEnum(string, g_noxPickupNames);
			  }
		  }
...
ThingBin::ThingBin(boost::restricted)
{
	Is_Loaded = false;
}
