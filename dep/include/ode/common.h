...
#define dRecip(x) ((float)(1.0/(x)))				/* reciprocal */
#define dSqrt(x) ((float)sqrtf(float(x)))			/* square root */
#define dRecipSqrt(x) ((float)(1.0/sqrtf(float(x))))		/* reciprocal square root */
...
#define dAtan2(y,x) ((float)atan2(float(y),float(x)))		/* arc tangent with 2 args */
...
//struct dxSpace; // removed for flatland
struct dxBody;		/* rigid body (dynamics object) */
//struct dxGeom; // removed for flatland
struct dxJoint;
struct dxJointNode;
struct dxJointGroup;

typedef struct dxWorld *dWorldID;
//typedef struct dxSpace *dSpaceID; // removed for flatland
typedef struct dxBody *dBodyID;
//typedef struct dxGeom *dGeomID; // removed for flatland
...
namespace Flatland { class Object; } // added for flatland
typedef class Flatland::Object* dGeomID; // added for flatland
typedef class Flatland::Object dxGeom; // added for flatland
void dGeomMoved (dGeomID); // moved for flatland
dGeomID dGeomGetBodyNext (dGeomID); // moved for flatland
#endif
