...
ObjectMgr::ObjectMgr()
{
	...
	enchantTable[ ENCHANT_INVISIBLE ] = EnchantEntry("ENCHANT_INVISIBLE", 1800, SOUND_INVISIBILITYON, SOUND_INVISIBILITYOFF);
	enchantTable[ ENCHANT_MOONGLOW ] = EnchantEntry("ENCHANT_MOONGLOW", 9000, SOUND_MOONGLOWON, SOUND_MOONGLOWOFF);
	enchantTable[ ENCHANT_BLINDED ] = EnchantEntry("ENCHANT_BLINDED", SOUND_BLINDON, SOUND_BLINDOFF);
	enchantTable[ ENCHANT_CONFUSED ] = EnchantEntry("ENCHANT_CONFUSED", 90, SOUND_CONFUSEON, SOUND_CONFUSEOFF);
	enchantTable[ ENCHANT_SLOWED ] = EnchantEntry("ENCHANT_SLOWED", 120, SOUND_SLOWON, SOUND_SLOWOFF);
	enchantTable[ ENCHANT_HELD ] = EnchantEntry("ENCHANT_HELD", 60, SOUND_STUNON, SOUND_STUNOFF);
	enchantTable[ ENCHANT_DETECTING ] = EnchantEntry("ENCHANT_DETECTING");
	enchantTable[ ENCHANT_ETHEREAL ] = EnchantEntry("ENCHANT_ETHEREAL");
	enchantTable[ ENCHANT_RUN ] = EnchantEntry("ENCHANT_RUN", 90, SOUND_RUNON, SOUND_RUNOFF);
	enchantTable[ ENCHANT_HASTED ] = EnchantEntry("ENCHANT_HASTED", 600, SOUND_HASTEON, SOUND_HASTEOFF);
	...
	enchantTable[ ENCHANT_VAMPIRISM ] = EnchantEntry("ENCHANT_VAMPIRISM", 900, SOUND_VAMPIRISMON, SOUND_VAMPIRISMOFF);
	enchantTable[ ENCHANT_ANCHORED ] = EnchantEntry("ENCHANT_ANCHORED", 300, SOUND_ANCHORON, SOUND_ANCHOROFF);
	enchantTable[ ENCHANT_LIGHT ] = EnchantEntry("ENCHANT_LIGHT", 9000, SOUND_LIGHTON, SOUND_LIGHTOFF);
	enchantTable[ ENCHANT_DEATH ] = EnchantEntry("ENCHANT_DEATH");
	enchantTable[ ENCHANT_PROTECT_FROM_FIRE ] = EnchantEntry("ENCHANT_PROTECT_FROM_FIRE", 1800, SOUND_PROTECTIONFROMFIREON, SOUND_PROTECTIONFROMFIREOFF);
	enchantTable[ ENCHANT_PROTECT_FROM_POISON ] = EnchantEntry("ENCHANT_PROTECT_FROM_POISON", 1800, SOUND_PROTECTIONFROMPOISONON, SOUND_PROTECTIONFROMPOISONOFF);
	enchantTable[ ENCHANT_PROTECT_FROM_MAGIC ] = EnchantEntry("ENCHANT_PROTECT_FROM_MAGIC", 1800, SOUND_PROTECTIONFROMMAGICON, SOUND_PROTECTIONFROMMAGICOFF);
	enchantTable[ ENCHANT_PROTECT_FROM_ELECTRICITY ] = EnchantEntry("ENCHANT_PROTECT_FROM_ELECTRICITY", 1800, SOUND_PROTECTIONFROMELECTRICITYON, SOUND_PROTECTIONFROMELECTRICITYOFF);
	enchantTable[ ENCHANT_INFRAVISION ] = EnchantEntry("ENCHANT_INFRAVISION", 900);
	enchantTable[ ENCHANT_SHOCK ] = EnchantEntry("ENCHANT_SHOCK", 600, SOUND_SHOCKON, SOUND_SHOCKOFF);
	...
	enchantTable[ ENCHANT_SHIELD ] = EnchantEntry("ENCHANT_SHIELD", 0, SOUND_FORCEFIELDCAST, SOUND_SHIELDOFF);
