...
enum NoxSubclassType
{
	...
	SUBCLASS_SWORD,
	SUBCLASS_LONG_SWORD,
	SUBCLASS_GREAT_SWORD,
	SUBCLASS_MACE,
	SUBCLASS_AXE,
	SUBCLASS_OGRE_AXE,
	SUBCLASS_HAMMER,
	SUBCLASS_STAFF,
	SUBCLASS_STAFF_SULPHOROUS_FLARE,
	SUBCLASS_STAFF_SULPHOROUS_SHOWER,
	SUBCLASS_STAFF_LIGHTNING,
	SUBCLASS_STAFF_FIREBALL,
	SUBCLASS_STAFF_TRIPLE_FIREBALL,
	SUBCLASS_STAFF_FORCE_OF_NATURE,
	SUBCLASS_STAFF_DEATH_RAY,
	SUBCLASS_STAFF_OBLIVION_HALBERD,
	SUBCLASS_STAFF_OBLIVION_HEART,
	SUBCLASS_STAFF_OBLIVION_WIERDLING,
	SUBCLASS_STAFF_OBLIVION_ORB
};
enum NoxFlagType
{
